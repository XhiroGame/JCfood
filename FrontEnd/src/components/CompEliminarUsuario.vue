<template>
    ...
    <div class="container-login">
        <div class="wrap-login">
            <form class="login-form validate-form" id="formLogin" v-on:submit.prevent="EliminarUsuario">
                <span class="login-form-title">Eliminar Usuario</span>
                <br>
                ...
                <div class="container-login-form-btn">
                    ...
                    <div class="wrap-login-form-btn">
                        ...
                        <button type="button" name="" class="login- form-btn" v-on:click="EliminarUsuario">ELIMINAR</button>
                        <br>
                    </div>
...
export default {
    ...
    methods: {
        ...
        EliminarUsuario() {
            var endpoint = "http://localhost:8080/usuarios/eliminar/" + this.busqueda;
            ...
            fetch(endpoint, opciones).then(async Response => {
                ...
                try {
                    if (Response.status)
                        Swal.fire({
                            ...
                            if (result.isConfirmed) {
                                ...
                                this.$router.push('/EliminarUsuario');

                            } else if (result.isDenied) {
                                Swal.fire('Los cambios no se Eliminaron', '', 'warning')
                                return false
                            }
                        })
                    else {
                    ...
                    return "{\"sucess\":false ,\"message\":\"Error al intentar Eliminar.\"}";
                }
            })
        }
    }
